...
do
  ...
  ./ttp4 $instancia4 $opt4461 $plan4460
  ./ttp5 $instancia5 $opt4461 $plan22300
  ./ttp8 $instancia8 $opt33810 $plan169045
  ./ttp9 $instancia9 $opt33810 $plan338090
  ./ttp4 $instancia4 $opt4461 $plan4460
  ./ttp5 $instancia5 $opt4461 $plan22300
  ./ttp6 $instancia6 $opt4461 $plan44600
  ./ttp6 $instancia6 $opt4461 $plan44600
done
